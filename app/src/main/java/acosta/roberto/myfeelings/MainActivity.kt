package acosta.roberto.myfeelings

import acosta.roberto.myfeelings.utilies.CustomBarDrawable
import acosta.roberto.myfeelings.utilies.CustomCircleDrawable
import acosta.roberto.myfeelings.utilies.Emociones
import acosta.roberto.myfeelings.utilies.JSONFile
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!data){
            ...
            graphTriste.background = CustomBarDrawable(this, Emociones("Triste", 0.0F, R.color.blue,sad))
            graphMuyTriste.background = CustomBarDrawable(this, Emociones("Muy triste", 0.0F, R.color.deepblue,verysad ))
        } else{
            actualizarGrafica()
            iconoMayoria()
        }
    ...
    fun actualizarGrafica(){
        ...
        graphTriste.background = CustomBarDrawable(this, Emociones("Triste", pS, R.color.blue, sad))
        graphMuyTriste.background = CustomBarDrawable(this, Emociones("Muy triste", pVS, R.color.mustard, verysad))
